...
setup(
    ...
    entry_points={
        'openmmml.potentials': [
            ...
            'orb = openmmml.models.orbpotential:OrbPotentialImplFactory',
            'orb-v3-omat = openmmml.models.orbpotential:OrbPotentialImplFactory',
            'orb-v3-omol = openmmml.models.orbpotential:OrbPotentialImplFactory',
