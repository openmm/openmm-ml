...
setup(
    ...
    entry_points={
        'openmmml.potentials': [
            ...
            'fennix-bio1S = openmmml.models.fennixpotential:FeNNixPotentialImplFactory',
            'fennix-bio1M = openmmml.models.fennixpotential:FeNNixPotentialImplFactory',
            'fennix-bio1S-finetuneIons = openmmml.models.fennixpotential:FeNNixPotentialImplFactory',
            'fennix-bio1M-finetuneIons = openmmml.models.fennixpotential:FeNNixPotentialImplFactory',
